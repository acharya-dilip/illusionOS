...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    GtkWidget *buttonJustaGuiFramework = gtk_button_new();
    gtk_grid_attach(GTK_GRID(mainWidget.gridParent), buttonJustaGuiFramework, 1, 3, 1, 1);
    gtk_widget_set_size_request(buttonJustaGuiFramework, 84, 84);
    gtk_widget_add_css_class(buttonJustaGuiFramework, "DesktopIcon");
    gtk_widget_add_css_class(buttonJustaGuiFramework, "IconJustaGuiFramework");
    g_signal_connect(buttonJustaGuiFramework, "clicked", G_CALLBACK(JustaGuiFramework), NULL);
    gtk_widget_set_hexpand(buttonJustaGuiFramework,FALSE);
    gtk_widget_set_vexpand(buttonJustaGuiFramework,FALSE);

    //Init of buttonNotSoSpacy
    GtkWidget *buttonNotSoSpacy = gtk_button_new();
    gtk_grid_attach(GTK_GRID(mainWidget.gridParent), buttonNotSoSpacy, 0, 4, 1, 1);
    gtk_widget_set_size_request(buttonNotSoSpacy, 84, 84);
    gtk_widget_add_css_class(buttonNotSoSpacy, "DesktopIcon");
    gtk_widget_add_css_class(buttonNotSoSpacy, "IconNotSoSpacy");
    g_signal_connect(buttonNotSoSpacy, "clicked", G_CALLBACK(NotSoSpacy), NULL);
    gtk_widget_set_hexpand(buttonNotSoSpacy,FALSE);
    gtk_widget_set_vexpand(buttonNotSoSpacy,FALSE);

    //Init of buttonNotSoNotSpooky
    GtkWidget *buttonNotSoNotSpooky = gtk_button_new();
    gtk_grid_attach(GTK_GRID(mainWidget.gridParent), buttonNotSoNotSpooky, 1, 4, 1, 1);
    gtk_widget_set_size_request(buttonNotSoNotSpooky, 84, 84);
    gtk_widget_add_css_class(buttonNotSoNotSpooky, "DesktopIcon");
    gtk_widget_add_css_class(buttonNotSoNotSpooky, "IconNotSoNotSpooky");
    g_signal_connect(buttonNotSoNotSpooky, "clicked", G_CALLBACK(NotSoNotSpooky), NULL);
    gtk_widget_set_hexpand(buttonNotSoNotSpooky,FALSE);
